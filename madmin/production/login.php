...
<head>
  ...
  <title>Diyarbakır Yönetim Paneli</title>
...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href=""><b> Birtat </b> Yönetim Paneli</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Admin paneline erişmek için oturum açın</p>

      <form action="../msettings/islem.php" method="post">
