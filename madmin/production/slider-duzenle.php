    ...
    <section class="content">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                     ...
                     <p><?php echo $slidercek['slider_resimyol']; ?>  </p>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Resim Seç<span class="required">*</span> </label>
                    <div class="col-sm-10">
                     <input type="file" id="first-name" name="slider_resimyol"  value="<?php echo $slidercek['slider_resimyol']; ?>" class="form-control ">
                   </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Slider Ad <span class="required">*</span> </label>
                    <div class="col-sm-10">
                      <input type="text" id="first-name" name="slider_ad"  required="required" value="<?php echo $slidercek['slider_ad'] ?>" class="form-control" >
                    </div>
                 </div>
                  
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Slider Sırası <span class="required">*</span> </label>
                    <div class="col-sm-10">
                      <input type="text"  class="form-control" name="slider_sira"  required="required" value="<?php echo $slidercek['slider_sira'] ?>"  id="inputEmail3" placeholder="Slider Sıra No Girin">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Slider Durum <span class="required">*</span> </label>
                    <div class="col-sm-10">
            ...
            <input type="hidden" name="slider_resimyol" value="<?php echo $slidercek['slider_resimyol'] ?>"> 
                ...
                <div class="card-footer">
                  <button type="submit" name="sliderduzenle" class="btn btn-success float-right">Güncelle</button>
